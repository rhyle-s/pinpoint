...
export const metadata: Metadata = {
  ...
  description: 'Format templates, worked examples, and key rules for all 7 AGLC4 source types.',
}
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Format templates, worked examples, and the rules students get wrong most often — for all 8 source types.
        </p>
      </div>
