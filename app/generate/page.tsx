...
const VALID_SOURCE_TYPES: SourceType[] = ['case', 'legislation', 'journal', 'book', 'report', 'website', 'treaty']
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Select a source type, fill in the details, and get footnote, subsequent, and bibliography forms instantly.
        </p>
      </div>
